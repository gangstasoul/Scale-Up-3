...
var PuzzleSprint = {
  ...
  nextWord: function (isFirstWord) {
    ...
    if(
	  ...
	  imageElement1.src = './victory.gif';
	  imageElement2.src = './defeat.gif';
	  imageElement3.src = './defeat.gif';
...
$(function() {
  ...
  SprintTimer = new Timer({
    ...
    onTimeEnd: function(onTimeEnd) {
	  ...
	  var finalAudio = new Audio('./Duel_Of_Minds_files/finish.mp3');
	  finalAudio.play();
	  
	  imageElement.src = './Duel_Of_Minds_files/Blue-team.png';
	  imageElement_2.src = './Duel_Of_Minds_files/Red-team.png';
	  imageElement1.src = './Duel_Of_Minds_files/victory.gif';
	  imageElement2.src = './Duel_Of_Minds_files/defeat.gif';
	  imageElement3.src = './Duel_Of_Minds_files/tie.gif';
	  imageElement4.src = './Duel_Of_Minds_files/tie.gif';
